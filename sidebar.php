    ...
    <section class="socialBanners">
        ...
        <div class="banners">
            <ul>
                ...
                <li><a href="https://www.twitter.com/gihyo.hotel" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/images/common/bnr_tw01.png" height="60" width="290" alt=""></a></li>
